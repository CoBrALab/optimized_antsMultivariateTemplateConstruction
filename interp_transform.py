...
# Input transform
input_itk_transform = sitk.ReadTransform(sys.argv[1])
...
vtk_transform_interpolator.InterpolateTransform(float(sys.argv[2]), output_vtk_transform)
...
sitk.WriteTransform(output_itk_transform, sys.argv[3])
