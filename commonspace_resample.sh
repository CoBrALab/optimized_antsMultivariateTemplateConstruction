...
# ARG_OPTIONAL_SINGLE([append-transforms],[],[Comma separated list of transforms to apply at the end of transform chain, used by twolevel wrapper],[])
...
print_help()
{
  ...
  printf '\t%s\n' "--append-transforms: Comma separated list of transforms to apply at the end of transform chain, used by twolevel wrapper (no default)"
}
