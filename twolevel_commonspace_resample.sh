...
# ARG_HELP([Common space resampling post-processing for twolevel_modelbuild.sh from optimized_antsMultivariateTemplateConstruction])
...
print_help()
{
  printf '%s\n' "Common space resampling post-processing for twolevel_modelbuild.sh from optimized_antsMultivariateTemplateConstruction"
